...
function Login() {
  ...
  return (
    <div className='flex items-center justify-center w-full py-6'>
        <div className='mx-auto w-full max-w-lg border-2 border-[#dcca95] bg-[#eae1be]  rounded-xl p-10 shadow'>
            <h2 className='text-center text-2xl font-bold text-[#62472c] leading-tight'>Sign in to your account</h2>
            ...
            <form onSubmit={handleSubmit(login)} className='mt-8'>
                <div className='space-y-5'>
                    ...
                    <Button type="submit" className="w-full py-2 px-5 text-center text-[18px] font-medium rounded-lg border border-transparent bg-[#f5f1df] border-[#dcca95] text-[#966a38] hover:bg-[#c29a4d] hover:text-[#f5f1df] focus:outline-none  disabled:opacity-50 disabled:pointer-events-none dark:text-blue-400 dark:hover:bg-blue-900 dark:focus:bg-blue-900">Signin {isLoading && <Loading />} </Button>
                </div>
            </form>
            <p className="mt-2 text-center text-base text-[#966a38]">
                Don&apos;t have any account?&nbsp;
                <Link to="/signup" className="!text-[#62472c] font-bold text-primary transition-all duration-200 hover:underline">
                    Sign Up
                </Link>
            </p>
        </div>
