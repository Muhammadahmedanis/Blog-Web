...
function Signup() {
  ...
  return (
    <div className="flex items-center justify-center py-4 pt-24">
        <div className={`mx-auto w-full max-w-lg shadow bg-blue-100 rounded-xl p-10 border border-black/10`}>
            ...
            <form onSubmit={handleSubmit(create)}>
                <div className='space-y-5'>
                    ...
                    <Button type="submit" className="w-full py-2 px-5 text-center text-[18px] font-medium rounded-lg border border-transparent bg-blue-200 text-blue-800 hover:bg-blue-300 focus:outline-none focus:bg-blue-200 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-400 dark:hover:bg-blue-900 dark:focus:bg-blue-900">Create Account</Button>
                </div>
            </form>
