        ...
        return(
            ...
            <div className="flex flex-wrap justify-center gap-2">
                <div className="px- border-[rgb(219,202,154)] border-2 w-[320px] md:w-[480px] lg:w-[650px] text-left rounded">
                    <h3 className="font-extrabold text-[16px] lg:text-[28px] m-3">
                    Create Your Own Blog and Share Your Unique Story with the World.
                    </h3>
                    <p className="m-3 text-[17px]">
            ...
            <div className='bg-[rgb(219,202,154)] my-2'>
                <div className='flex justify-center items-center gap-1'>
                    <h2 className='text-2xl font-bold py-1'> Most read Articles </h2>
                    <RiArticleFill className='mt-1' size={20}/>
                </div>
